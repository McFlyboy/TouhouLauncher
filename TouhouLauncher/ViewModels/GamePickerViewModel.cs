...
public class GamePickerViewModel : ObservableRecipient
{
    ...
    )
    {
        ...
        Messenger.Register<GamePickerViewModel, GamePickerUpdateGamesMessage>(this, static (r, m) => r.UpdateGames());
    ...
    public class GameButton
    {
        ...
        )
        {
            ...
            EditCommand = new RelayCommand(() =>
            {
                ...
                _parent.Messenger.Send(new MainViewChangePageMessage("FanGameEditorPage.xaml"));
            });
        }
...
public record GamePickerUpdateGamesMessage();
