...
public class FileAccessServiceTest
{
    ...
    [Fact]
    public async Task Returns_error_when_trying_to_read_nonexisting_file_async_to_string()
    {
    ...
    [Fact]
    public async Task Returns_read_content_async_from_file_as_string()
    {
    ...
    [Fact]
    public async Task Returns_error_when_failing_to_create_file_to_write_to_from_string_async_when_file_path_is_not_provided()
    {
    ...
    [Fact]
    public async Task Returns_null_when_writing_string_content_async_to_file()
    {
    ...
    [Fact]
    public async Task Returns_error_when_trying_to_read_nonexisting_file_async_to_yaml()
    {
    ...
    [Fact]
    public async Task Returns_read_content_async_from_file_as_yaml()
    {
    ...
    [Fact]
    public async Task Returns_error_when_failing_to_create_file_to_write_to_from_yaml_async_when_file_path_is_not_provided()
    {
    ...
    [Fact]
    public async Task Returns_null_when_writing_yaml_content_async_to_file()
    {
    ...
    [Fact]
    public async Task Returns_error_when_trying_to_read_nonexisting_file_async_to_ini()
    {
    ...
    [Fact]
    public async Task Returns_read_content_async_from_file_as_ini()
    {
    ...
    [Fact]
    public async Task Returns_error_when_failing_to_create_file_to_write_to_from_ini_async_when_file_path_is_not_provided()
    {
    ...
    [Fact]
    public async Task Returns_null_when_writing_ini_content_async_to_file()
    {
