				...
				Sections = new() {
					new Section("NekoProject21") {
						Properties = new() {
							...
							new Property("opt26BRD", "some text..."),
							new Property("opt86BRD", "some text..."),
							new Property("optSPBRD", "some text..."),
							new Property("optSPBVR", "some text..."),
							new Property("optSPBVL", "some text..."),
							new Property("optSPB_X", "true"),
							new Property("optMPU98", "5"),
